...
// skills, and future non-UI generation tools. Keep this name non-hidden so
// users can find generated HTML/images/scripts without digging through
// project metadata folders.
